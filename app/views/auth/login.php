 ...
 * Login View
 *
 * Included directly via require from AuthController::showLogin().
 * Variables injected by the controller into local scope:
 *
 * @var string $csrfToken  CSRF token generated by Security::getCSRFToken()
 */
?>
<!DOCTYPE html>
<html lang="id">
