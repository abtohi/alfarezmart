...
<body>
    ...
    <script src="<?= BASE_URL ?>public/js/offline-db.js?v=10.3"></script>
    ...
    <script src="<?= BASE_URL ?>public/js/components.js?v=10.3"></script>
    ...
    <script>
    const APP_VERSION = '10.3'; // Update this to force client reloads
