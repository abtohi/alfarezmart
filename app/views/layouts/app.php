...
<body>
    ...
    <script src="<?= BASE_URL ?>public/js/offline-db.js?v=10.4"></script>
    ...
    <script src="<?= BASE_URL ?>public/js/components.js?v=10.4"></script>
    ...
    <script>
    const APP_VERSION = '10.4'; // Update this to force client reloads
