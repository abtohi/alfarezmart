...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    function toggleMultivariant(checked) {
        ...
        if (mvCheck && mvCheck.checked !== checked) {
    ...
    window.toggleMultivariant = toggleMultivariant;
    ...
    if (isLevel1) {
        ...
        containedHtml = `
            <div style="flex:1;">
                ...
                <input type="number" name="contained_qty[]" placeholder="Cth: 10, 12, 24" class="form-control-dark contained-qty" style="width:100%;" min="0.001" step="any" required>
...
async function submitProduct(e) {
    ...
    updatedData.set('invoice_name', labelText);
        ...
        const newProduct = {
            ...
            brand_id: payload.brand_id ? parseInt(payload.brand_id) : null,
