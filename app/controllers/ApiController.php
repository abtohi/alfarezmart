...
class ApiController extends Controller
{
    ...
    public function addPackaging(int $productId)
    {
        ...
        try {
            ...
            if ($newLevel > 1 && $containedQty < 2) throw new Exception("Isi kemasan minimal 2");
