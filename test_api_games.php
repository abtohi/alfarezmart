...
$productsGames = $model->getProducts('games', null, 'prepaid');
$productsGame = $model->getProducts('game', null, 'prepaid');

echo "games count: " . count($productsGames) . "\n";
echo "game count: " . count($productsGame) . "\n";
